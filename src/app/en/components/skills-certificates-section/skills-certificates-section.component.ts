...
@Component({
  selector: 'app-skills-certificates-section-es',
...
export class SkillsCertificatesSectionComponent implements OnInit {
  ...
  certificates = [
    ...
    {
      id: 3,
      name: 'Bootstrap 4 Components',
      url: './assets/pdf/certificates/certificado_bootstrap_4__componentes.pdf',
    },
    {
      id: 4,
      name: 'Bootstrap 4 Responsive Maquetation and Layout',
    ...
    {
      id: 11,
      name: 'Specialization in Javascript Asynchrony, Prototypes and Classes',
    ...
    {
      id: 13,
      name: 'Javascript Web Api, Components and Testing',
